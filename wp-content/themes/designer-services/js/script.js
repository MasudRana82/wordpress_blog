...
function designer_services_open_menu() {
...
jQuery( "button.menu-toggle").on("click", designer_services_open_menu);

function designer_services_close_menu() {
  jQuery('button.close-menu').removeClass('close-panal');
  jQuery('nav#main-menu').hide();
}

jQuery( "button.close-menu").on("click", designer_services_close_menu);
...
function designer_services_projects_tab(evt, cityName) {
